        ...
        <div class="box-body">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" required class="form-control" id="name" name="name" placeholder="Curriculum Name" minlength="6" title="Min length must be an 6 character" value="{{$curriculum_details->name }}">
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" required class="form-control" id="name" name="abbreviation" placeholder="Curriculum Abbreviation" title="Min length must be an 6 character" value="{{$curriculum_details->abbreviation }}">
                </div>
            </div>

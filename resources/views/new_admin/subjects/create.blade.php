...
@section('content-header', 'Subject')

@section('breadcrumb')
    <li><a href="{{route('admin.channels.index')}}"><i class="fa fa-suitcase"></i>Subject</a></li>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <div class="box-header label-primary">
                <b style="font-size:18px;">Add Subject</b>
                <a href="{{ route('admin.channels.index') }}" class="btn btn-default pull-right">Subject</a>
            </div>

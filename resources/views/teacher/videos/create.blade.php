                                     ...
                                     <div class="form-data">
                                       ...
                                       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                           ...
                                           <div>
                                             ...
                                             <select id="category_id" name="country" class="form-control select2 country_change" required data-placeholder="{{tr('select_category')}}*" style="width: 100% !important">
                                     ...
                                     <div class="form-data">
                                       ...
                                       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                           ...
                                           <div>
                                             ...
                                             <select  name="class" class="form-control class_change" required style="width: 100% !important">
                                       ...
                                       <label for="video" class="control-label">{{tr('curriculum')}}  * </label>
                                           <div>
                                             ...
                                             <select  name="curriculum" class="form-control curriculum_changee" required  style="width: 100% !important">
 ...
 <script type="text/javascript">
         ...
         $('.country_change').on('change', function (e){
              ...
              if(len > 0){
                ...
                $('.class_change').children('option').remove();
                 ...
                 for(var i=0; i<len; i++){
                  ...
                  var option = "<option value='"+class_id+"'>"+name+"</option>"; 
 
                  $(".class_change").append(option); 
                }
           ...
           if(len==1 && class_id){
              ...
              $.ajax(
              {
                 url: 'curriculum_select_data/'+class_id,
                 type: 'get',
                 dataType: 'json',
     ...
     <script type="text/javascript">
         ...
         $('.class_change').on('change', function (e){

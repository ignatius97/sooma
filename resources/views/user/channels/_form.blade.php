...
<div class="y-content">
    ...
    <div class="row content-row">
        ...
        <div class="page-inner col-sm-9 col-md-10 col-lg-9" style="margin-left: 18%;">
				...
				<div class="branded-page-v2-header channel-header yt-card">
					...
					<div id="gh-banner" >
						...
						<div id="c4-header-bg-container" class="c4-visible-on-hover-container  has-custom-banner">
							<div class="hd-banner" style="margin-top: 1%;">
							...
							<div id="header-links" style="margin-right: 10%;">
								...
								<button class="st_button" onclick="$('#picture').click();return false">
									@if($model->id)
									<i class="fa fa-plus-circle"></i>&nbsp;Edit profile photo
									@else

									<i class="fa fa-plus-circle"></i>&nbsp;Add profile photo
									@endif

								</button>
							</div>
							<div class="st_photo_div" style="margin-left: 5%;">
			...
			<div class="slide-area recom-area abt-sec des-crt">
				...
				<div class="abt-sec-head description-create">
					...
					<div class="des-box">
						...
						<h5>Description about the class</h5>
